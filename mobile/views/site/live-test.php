...
.bottom-section{
    height:100%;
    background : url("/assets/img/test-1.jpg") repeat-y 0% 0%;
}
.scrolltop{
    width:100%;
    max-height:24%;
...
<body ng-app="myApp" ng-controller="myCtrl">
    <div class="building-area">
    	<div class="building-list">
            <img src="/assets/img/bg-original.jpg" alt="" class="img-full" name="building-bg">
    	</div>
    	<div class="bottom-section">
            <img src="/assets/img/test-welcome.png" style="width:20%;margin:0 auto;display:block;margin-bottom:2%;">
    	    <div class="scrolltop">
                <ul class="scroll-list">
                    <li class="scroll-detail row">
                        <div class="col col-33">
                            <img src="/assets/img/light.png" style="width: 5%;height:5%;">
...
CreateBuilding.prototype = {
  init: function() {
    ...
    building.css({
      ...
      'width' : this.width +'%',
      'height' : this.height +'%',
      'background' : 'url("/assets/img/1_1.png") no-repeat 0% 0% / 100% auto'
    });
...
//      'background' : background ? background : 'url("/assets/img/light.png") no-repeat 0% 0% / 100% auto'
//    });
//
//  }
};
...
app.controller('myCtrl', function($scope, $http, $interval) {
    $scope.button="/assets/img/test-2.png";
    $scope.action={
        switch:function () {
            if($scope.button=="/assets/img/test-2.png"){
                $scope.button="/assets/img/test-3.png";
            }else{
                $scope.button="/assets/img/test-2.png";
            }
        }
...
//    };
    var img = new Image();
    img.src = "/assets/img/runyuan.png";

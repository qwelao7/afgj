...
/***/ function(module, exports, __webpack_require__) {
	...
	echarts.extendSeriesModel({
	    ...
	    defaultOption: {
	        color: ['#009042', '#64b348', '#8fc741', '#b1daa2'],
	        center: ['50%', '50%'],
	        radius: '50%',
	        amplitude: '8%',
	        waveLength: '80%',
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Path.extend = function (defaults) {
	        ...
	        // FIXME ���� extend position, rotation �����ö���
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Displayable.prototype = {
	        ...
	        /**
	         * Displayable �Ƿ�Ϊ�࣬Painter �л���ݸñ���ж��Ƿ���Ҫ�Ƿ���Ҫ���»���
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Element.prototype = {
	        ...
	        /**
	         * ZRender ʵ�����󣬻��� element ��ӵ� zrender ʵ���к��Զ���ֵ
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * �ж��Ƿ���Ҫ������任
	     * ���������任, ���position, rotation, scale�Լ����ڵ��transform����������transform����
	     */
	    ...
	    /**
	     * �ֽ�`transform`����`position`, `rotation`, `scale`
	     */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Animatable.prototype = {
	         ...
	         * ����
	         *
	         * @param {string} path ��Ҫ��Ӷ��������Ի�ȡ·��������ͨ��a.b.c����ȡ��������
	         * @param {boolean} [loop] �����Ƿ�ѭ��
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Animator.prototype = {
	        /**
	         * ���ö����ؼ�֡
	         * @param  {number} time �ؼ�֡ʱ�䣬��λ��ms
	         * @param  {Object} props �ؼ�֡������ֵ��key-value��ʾ
	         * @return {module:zrender/animation/Animator}
	         */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function Clip(options) {
	        ...
	        // ��ʼʱ��
	        // this._startTime = new Date().getTime() + this._delay;// ��λ����
	        ...
	        step: function (globalTime) {
	            ...
	            if (percent == 1) {
	                if (this.loop) {
	                    ...
	                    // ���¿�ʼ����
	                    // �׳�������ֱ�ӵ����¼�ֱ�� stage.update ����ͳһ������Щ�¼�
	                    return 'restart';
	                }

	                // ������ɽ������������ʶΪ��ɾ��
	                // ��Animation.update�н�������ɾ��
...
/***/ function(module, exports) {
	    ...
	    var config = {
	        /**
	         * debug��־ѡ�catchBrushExceptionΪtrue����Ч
	         * 0 : ������debug���ݣ�������
	         * 1 : �쳣�׳���������
	         * 2 : ����̨�����������
	         */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function truncateText(text, containerWidth, textFont, ellipsis, options) {
	        ...
	        // Example 2: minChar: 3, text: 'ά��', truncate result: 'ά', but not: '...'.
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	/**
	 * Path ����������`buildPath`���������`ctx`, �ᱣ��ÿ��path���������pathCommands������
	 * �������� isInsidePath �ж��Լ���ȡboundingRect
	 *
	 ...
	 // TODO getTotalLength, getPointAtLength
	    ...
	    PathProxy.prototype = {
	        ...
	        moveTo: function (x, y) {
	            ...
	            // x0, y0, xi, yi �Ǽ�¼�� _dashedXXXXTo ������ʹ��
	            // xi, yi ��¼��ǰ��, x0, y0 �� closePath ��ʱ��ص���ʼ�㡣
	            // �п����� beginPath ֮��ֱ�ӵ��� lineTo����ʱ�� x0, y0 ��Ҫ
	            // �� lineTo �����м�¼�������Ȳ��������������dashed line Ҳֻ�� IE10- �в�֧��
	            this._x0 = x;
	            this._y0 = y;
	        ...
	        /**
	         * Context ���ⲿ���룬��Ϊ�п����� rebuildPath ��֮���� fill��
	         * stroke ͬ��
	         * @param {CanvasRenderingContext2D} ctx
	         * @return {module:zrender/core/PathProxy}
	         */
	        ...
	        /**
	         * ��� Path ���ݡ�
	         * �������ö��������µ����顣�󲿷�ͼ���ػ��ָ�����ݳ��ȶ��ǲ���ġ�
	         */
	        addData: function (cmd) {
	            var data = this.data;
	            if (this._len + arguments.length > data.length) {
	                // ��Ϊ֮ǰ�������Ѿ�ת���ɾ�̬�� Float32Array
	                // ���Բ�����ʱ��Ҫ��չһ���µĶ�̬����
	                this._expandData();
	                data = this.data;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var yDim = [];
	    /**
	     * �����ױ���������(p0, p1, p2, p3)�м������С��Χ�У�д��`min`��`max`��
	     * @memberOf module:zrender/core/bbox
	     * @param {number} x0
	     * @param {number} y0
	     * @param {number} x1
	    ...
	    /**
	     * �Ӷ��ױ���������(p0, p1, p2)�м������С��Χ�У�д��`min`��`max`��
	     * @memberOf module:zrender/core/bbox
	     * @param {number} x0
	     * @param {number} y0
	     * @param {number} x1
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Group��һ�����������Բ����ӽڵ㣬Group�ı任Ҳ�ᱻӦ�õ��ӽڵ���
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Catmull-Rom spline ��ֵ����
	 * @module zrender/shape/util/smoothSpline
	 * @author pissang (https://www.github.com/pissang)
	 *         Kener (@Kener-�ַ�, kener.linfeng@gmail.com)
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {Array} points �߶ζ�������
	     * @param {number} smooth ƽ���ȼ�, 0-1
	     * @param {boolean} isLoop
	     * @param {Array} constraint ����������Ŀ��Ƶ�Լ����һ����Χ����
	     *                           ���� [[0, 0], [100, 100]], �����Χ�л���
	     *                           �������ߵİ�Χ����һ����������Լ�����Ƶ㡣
	     * @param {Array} ��������Ŀ��Ƶ�����
	     */
